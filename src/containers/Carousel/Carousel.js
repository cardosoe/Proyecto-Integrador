      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p class="carousel_text">Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <p class="carousel_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
